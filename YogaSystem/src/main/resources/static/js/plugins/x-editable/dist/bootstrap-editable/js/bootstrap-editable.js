            ...
            */
            ...
            if (send) { //send to server
                ...
                if(typeof this.options.url === 'function') { //user's function
                    ...
                    //send ajax to server and return red object
                    return $.ajax($.extend({
    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/
        ...
        If function - it will be called instead of ajax. Function should return red object to run fail/done callbacks.
        ...
        url: function(params) {
            var d = new $.red;
            if(params.value === 'abc') {
                return d.reject('error message'); //returning error via red object
            } else {
...
(function ($) {
    ...
    AbstractInput.prototype = {
       ...
       */
       ...
       /**
        Renders input from tpl. Can return jQuery red object.
    ...
    $.extend(List.prototype, {
        ...
        value2html: function (value, element, display, response) {
            ...
            if(value === null) {
               ...
               this.onSourceReady(success, function () { red.resolve(); });
            }
